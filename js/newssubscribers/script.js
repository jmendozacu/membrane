...
jQuery(function() {
    ...
    jQuery('#esns_submit').click(function(){
        ...
        /*Indian Code For Loader Show Start*/
        $j("#newsletter_popup_loader").css("display","block");
        /*Indian Code For Loader Show End*/
        jQuery.post(EsNewsSubscribers.getBaseUrl()+'newsletter/subscriber/newajax/', {'email':email}, function(resp) {
            if (resp.errorMsg) {
                 /*Indian Code For Loader Hide Start*/
                $j("#newsletter_popup_loader").css("display","none");
                /*Indian Code For Loader Hide End*/
