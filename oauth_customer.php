...
$callbackUrl = "http://localhost:81/git_indiankalaniketan.com/oauth_customer.php";
$temporaryCredentialsRequestUrl = "http://localhost:81/git_indiankalaniketan.com/oauth/initiate?oauth_callback=" . urlencode($callbackUrl);
$customerAuthorizationUrl = 'http://localhost:81/git_indiankalaniketan.com/oauth/authorize';
$accessTokenRequestUrl = 'http://localhost:81/git_indiankalaniketan.com/oauth/token';
$apiUrl = 'http://localhost:81/git_indiankalaniketan.com/api/rest';
$consumerKey = 'a7d50df0bd16ac4d2ad50f6460dde2ec';
$consumerSecret = 'a182f272fca824bf3454b27eebe48760';
